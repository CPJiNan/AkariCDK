package com.github.cpjinan.plugin.akaricdk.utils

import com.github.cpjinan.plugin.akaricdk.internal.manager.ConfigManager
import com.github.cpjinan.plugin.akaricdk.utils.LoggerUtil.message
import com.github.cpjinan.plugin.akaricdk.utils.VersionUtil.toSemanticVersion
...
object UpdateUtil {
    fun getPluginNotice() {
        Thread {
            val urlConnection =
                URL("https://cpjinan.github.io/Pages/AkariCDK/notice.html").openConnection() as HttpURLConnection
            try {
    ...
    fun getPluginUpdate() {
        Thread {
            val urlConnection =
                URL("https://cpjinan.github.io/Pages/AkariCDK/version.html").openConnection() as HttpURLConnection
            try {
